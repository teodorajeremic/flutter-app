...
class _BloodOxygenPageState extends State<BloodOxygenPage>
  ...
  List<BloodOxygenEntry> entries = [];
  List<BloodOxygenEntry> filteredEntries = [];
  ...
  Future<void> _loadFromBackend() async {
    try {
      ...
      item.containsKey("cycle_start_time") &&
        ...
        double temp =
            double.tryParse(item["blood_oxygen"].toString()) ?? 0;
        return BloodOxygenEntry(
            startDate: parsedDate, BloodOxygen: temp);
      }).toList();
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                entry.BloodOxygen == 0
                    ? '--'
                    : entry.BloodOxygen.toStringAsFixed(0),
                style: TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.w600,
                  color: entry.BloodOxygen > 0
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: SfCartesianChart(
                    ...
                    series: <SplineAreaSeries<BloodOxygenEntry, DateTime>>[
